 ...
 * @author NFTfi
 */
contract Refinancing is RefinancingAdapterRegistry, Flashloan, NftReceiver, Pausable {
    ...
    function refinance(
        ...
        obligationReceiptToken.safeTransferFrom(address(this), borrower, smartNftId);
    }
    ...
    function _refinanceFlashloanCallback(
        ...
        if (address(this) != IERC721(collateralContract).ownerOf(collateralId)) revert collateralNotOwned();
