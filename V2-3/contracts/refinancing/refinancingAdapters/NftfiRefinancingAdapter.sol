...
import "./IRefinancingAdapter.sol";
...
contract NftfiRefinancingAdapter is IRefinancingAdapter {
     ...
     */
    function getBorrowerAddress(address _loanContract, uint256 _loanIdentifier)
        external
        view
        override
        returns (address)
    ...
    function transferBorrowerRole(address _loanContract, uint256 _loanIdentifier) external override returns (bool) {
        ...
        require(borrower != address(0), "OR token doesn't exist");
     ...
     */
    function getCollateral(address _loanContract, uint256 _loanIdentifier)
        external
        view
        override
        returns (address nftCollateralContract, uint256 nftCollateralId)
    {
        // struct LoanTerms {
     ...
     */
    function getPayoffDetails(address _loanContract, uint256 _loanIdentifier)
        external
        view
        override
        returns (address loanERC20Denomination, uint256 maximumRepaymentAmount)
    {
        // struct LoanTerms {
        //     uint256 loanPrincipalAmount;
        //     uint256 maximumRepaymentAmount;
