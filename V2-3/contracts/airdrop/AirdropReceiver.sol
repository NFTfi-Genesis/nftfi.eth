    ...
    ReentrancyGuard
{
    ...
    function wrap(
        ...
        emit NftWrapped(_nftCollateralContract, _nftCollateralId, _from, msg.sender);
    ...
    function pullAirdrop(address _target, bytes calldata _data) external override nonReentrant onlyOwner {
        require(
    ...
    function onERC721Received(
        ...
        if (ownerOf(getTokenId()) == _from && !wrapping_) {
            ...
            _receiveAndWrap(_from, msg.sender, _tokenId);
        }
    ...
    function onERC1155Received(
        ...
        if (ownerOf(getTokenId()) == _from && !wrapping_) {
            ...
            // sender is the nftCollateral contract
            _receiveAndWrap(_from, msg.sender, _id);
        }
        // otherwise it is considered an airdrop
    ...
    function onERC1155BatchReceived(
        ...
        if (ownerOf(getTokenId()) == _from && !wrapping_) {
            ...
            // sender is the nftCollateral contract
            _receiveAndWrap(_from, msg.sender, _ids[0]);
        }
        // otherwise it is considered an airdrop
    ...
    function _receiveAndWrap(
        ...
        emit NftWrapped(_nftCollateralContract, _nftCollateralId, _from, _from);
    }
}
